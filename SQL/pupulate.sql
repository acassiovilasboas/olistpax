...
-- populate product
INSERT INTO product (category_id, name, quantity, price) VALUES (1, 'sabao líquido', 2, 15.90);
INSERT INTO product (category_id, name, quantity, price) VALUES (1, 'sabao em pó', 5, 13.50);
